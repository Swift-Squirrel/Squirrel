...
class NutParserTests: XCTestCase {
    ...
    func testSimpleParse() {
        ...
        let expexted = try! JSON(json: """
            {"head":[{"id":"title","expression":{"infix":"\\"Title of post\\"","id":"raw expression","line":1,"postfix":[{"type":{"string":"String"},"value":"Title of post"}]},"line":1}],"body":[{"id":"text","value":"\\nthis is about "},{"infix":"topic","id":"raw expression","line":2,"postfix":[{"type":{"variable":"Variable"},"value":"topic"}]}],"fileName":"Views\\/Post.nut"}
            """)
    ...
    func testCommonCommands() {
        ...
        let expexted = try! JSON(json: """
            {"body":[{"id":"text","value":"dasd alm ak po\\n"},{"id":"date","date":{"infix":"date","id":"raw expression","line":2,"postfix":[{"type":{"variable":"Variable"},"value":"date"}]},"line":2},{"id":"text","value":" oid\\n"},{"id":"if","condition":{"infix":"true","id":"raw expression","line":3,"postfix":[{"type":{"bool":"Bool"},"value":"true"}]},"line":3,"then":[{"id":"text","value":"\\n    asd a "},{"format":{"infix":"\\"m\\" + years","id":"raw expression","line":4,"postfix":[{"type":{"string":"String"},"value":"m"},{"type":{"variable":"Variable"},"value":"years"},{"type":{"operation":"+"},"value":"+"}]},"id":"date","line":4,"date":{"infix":"date1","id":"raw expression","line":4,"postfix":[{"type":{"variable":"Variable"},"value":"date1"}]}},{"id":"text","value":" asda\\n"}]},{"id":"text","value":"\\n"},{"id":"if","else":[{"id":"if","else":[{"id":"if let","condition":{"infix":"posts","id":"raw expression","line":10,"postfix":[{"type":{"variable":"Variable"},"value":"posts"}]},"line":10,"then":[{"id":"text","value":"\\n    doefja e\\n"}],"variable":"notNil"}],"condition":{"infix":"true == true","id":"raw expression","line":8,"postfix":[{"type":{"bool":"Bool"},"value":"true"},{"type":{"bool":"Bool"},"value":"true"},{"type":{"operation":"=="},"value":"=="}]},"line":8,"then":[{"id":"text","value":"\\n    "},{"infix":"true","id":"raw expression","line":9,"postfix":[{"type":{"bool":"Bool"},"value":"true"}]},{"id":"text","value":"\\n"}]}],"condition":{"infix":"1 + 3 == 4","id":"raw expression","line":6,"postfix":[{"type":{"int":"Int"},"value":"1"},{"type":{"int":"Int"},"value":"3"},{"type":{"operation":"+"},"value":"+"},{"type":{"int":"Int"},"value":"4"},{"type":{"operation":"=="},"value":"=="}]},"line":6,"then":[{"id":"text","value":"\\n    true\\n"}]},{"id":"text","value":"\\n"},{"id":"if let","else":[{"id":"text","value":"    ds\\n    "},{"id":"subview","name":"Subviews.Map","line":17},{"id":"text","value":"\\n"}],"condition":{"infix":"Tom","id":"raw expression","line":13,"postfix":[{"type":{"variable":"Variable"},"value":"Tom"}]},"line":13,"then":[{"id":"text","value":"\\n    dfe\\n"}],"variable":"asd"},{"id":"text","value":"\\n\\n"},{"array":"posts","id":"for in Array","body":[{"id":"text","value":"\\n    "},{"infix":"post.body","id":"raw expression","line":21,"postfix":[{"type":{"variable":"Variable"},"value":"post.body"}]},{"id":"text","value":"\\n"}],"line":20,"variable":"post"},{"id":"text","value":"\\n"},{"body":[{"id":"text","value":"\\n    "},{"infix":"key + \\" \\" + value","id":"raw expression","line":24,"postfix":[{"type":{"variable":"Variable"},"value":"key"},{"type":{"string":"String"},"value":" "},{"type":{"operation":"+"},"value":"+"},{"type":{"variable":"Variable"},"value":"value"},{"type":{"operation":"+"},"value":"+"}]},{"id":"text","value":"\\n"}],"id":"for in Dictionary","line":23,"array":"dictionary","key":"key","variable":"value"},{"id":"text","value":"\\npdso a"}],"fileName":"Subviews\\/Smt.nut"}
            """)
    ...
    func testViewCommands() {
        ...
        let expexted = try! JSON(json: """
            {"body":[{"id":"text","value":"dasd alm ak po\\n"},{"id":"text","value":"\\n"}],"fileName":"Views\\/Smt.nut","head":[{"id":"title","expression":{"infix":"\\"ds\\"","id":"raw expression","line":3,"postfix":[{"type":{"string":"String"},"value":"ds"}]},"line":3}],"layout":{"id":"layout","name":"Layouts.Default","line":2}}
            """)
